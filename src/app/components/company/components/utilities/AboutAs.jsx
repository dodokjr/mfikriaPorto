      ...
      <div className="md:max-w-5xl max-w-lg mx-auto">
        <div class="grid md:grid-cols-2 gap-6">
          <div className="max-w-sm">
            <h2 className="text-white text-3xl font-semibold mb-4 leading-10">Innovative Solutions for Modern Challenges, <br /> Your Success, Our Commitment</h2>
          </div>
          <div className="text-left">
            <p className="mb-4 text-sm text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin aliquam, ipsum vel iaculis bibendum, justo turpis ullamcorper mauris, non aliquam nisi purus vel nisl. Integer efficitur turpis in bibendum tincidunt.</p>
            <p className="text-sm text-white">Nulla facilisi. Vestibulum fringilla leo et purus consectetur, vel tincidunt dolor rhoncus. In hac habitasse platea dictumst. Fusce vel sodales elit. Suspendisse potenti. Sed eget consequat nisi.</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-16">
          <div>
            ...
            <div className="mt-4">
              <h3 className="text-lg font-bold text-white mb-2">Fresh Insights</h3>
              <p className="text-white text-sm">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum reprehenderit in voluptate velit esse cillum dolore...</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-4">
              <h3 className="text-lg font-bold text-white mb-2">Trending Now</h3>
              <p className="text-white text-sm">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum reprehenderit in voluptate velit esse cillum dolore...</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-4">
              <h3 className="text-lg font-bold text-white mb-2">Daily Highlights</h3>
              <p className="text-white text-sm">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum reprehenderit in voluptate velit esse cillum dolore...</p>
            </div>
          </div>
        </div>
