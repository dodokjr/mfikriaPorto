...
export default function Feature() {
  return (
    <div className="max-w-6xl mx-auto font-[sans-serif]">
      <h2 className="text-slate-200 sm:text-4xl text-2xl font-extrabold text-center mb-16">Discover Our Exclusive Features</h2>
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-12">
        <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          ...
          <div>
            ...
            <p className="text-white text-sm">Tailor our product to suit your needs Expand your reach with our global network.</p>
          </div>
        </div>
        ...
        <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          ...
          <div>
            ...
            <p className="text-white text-sm">Your data is protected by the latest security measures.</p>
          </div>
        </div>
        ...
        <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          ...
          <div>
            ...
            <p className="text-white text-sm">Tailor our product to suit your needs 24/7 customer support for all your inquiries.</p>
          </div>
        </div>
        ...
        <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          ...
          <div>
            <h3 className="text-white text-xl font-semibold mb-3">Performance</h3>
            <p className="text-white text-sm">Experience blazing-fast performance with our product.</p>
          </div>
        </div>
        ...
        <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          ...
          <div>
            <h3 className="text-white text-xl font-semibold mb-3">Global Reach</h3>
            <p className="text-white text-sm">Tailor our product to suit your needs Expand your reach with our global network.</p>
          </div>
        </div>
        ...
        <div className="p-4 flex gap-6 rounded-lg hover:shadow-md hover:scale-105 transition-all duration-300">
          ...
          <div>
            ...
            <p className="text-white text-sm">Tailor our product to suit your needs Seamless communication for your team.</p>
          </div>
        </div>
      </div>
    </div>
